$(function() {
    // alert("This is a HTML demo for test.\n\If infringement,please contact me,I will first priority.\n\E-mail:ypfj@outlook.com\n\页面练习");
    // 2个悬浮下拉菜单
    ...
    curSearchType.mouseover(function() {
        ...
        // search的下拉菜单
        $("#searchTab li").mouseover(function() {
            $(this).css("background-color", "#EDF3FC");
        }).mouseout(function() {
            $(this).css("background-color", "#fff");
        });
        $("#searchTab>ul>li").bind("click", function() {
